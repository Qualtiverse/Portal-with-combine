...
struct FlatBasicPortalRenderingMaterials_t
{
	...
	CTextureReference	m_PortalLightTransfer_ShadowTexture; //light transfers disabled indefinitely (MyGamepedia: not anymore)

	IMaterialVar		*m_pDepthDoubleViewMatrixVar;
};

//MyGamepedia: This is moved from portalrenderable_flatbasic.cpp to make c_prop_portal.cpp compile
